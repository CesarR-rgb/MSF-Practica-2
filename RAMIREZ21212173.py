"""
Práctica 2: Ssitema respiratorio
...
def plotsignals (u, sysS, sysE, sysPID, signal):
    ...
    plt.plot(t,pid,':', linewidth = 3, color = rosa, label = '$PA(t):Tratamiento$')
...
kP, kI, kD, Cr = 171.2458, 4040.7036, 0.9276, 1E-6
Re = 1/(kI*Cr)
Rr = kP*Re
Ce = kD/Rr
